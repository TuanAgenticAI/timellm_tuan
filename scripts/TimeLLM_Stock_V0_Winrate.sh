...
# Time-LLM Stock Prediction V0 - Baseline + Winrate Logging
# Identical to V0 except: thêm winrate log cho train/vali/test
...
# Run training
python run_stock_v0_winrate.py \
...
echo ""
echo "============================================"
echo "V0 Baseline + Winrate Training Complete!"
echo "============================================"
